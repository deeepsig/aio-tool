...
function NavButton({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`cursor-pointer hover:opacity-80 transition-all duration-150 hover:bg-white/5 rounded-md hover:px-2 hover:py-1 hover:-mx-1 hover:-my-1 text-sm font-medium text-[#ededed] disabled:opacity-50 disabled:cursor-not-allowed ${
